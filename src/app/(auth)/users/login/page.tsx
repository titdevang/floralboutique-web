    ...
    return (
        <div className=" h-full w-full">
            <div className="flex flex-col lg:flex-row border-0 lg:border border-gray-light w-full">
                ...
                {/* Right Form Section */}
                <div
                    className="lg:mt-0 mt-[-35px] md:mt-[-50px] z-10 bg-white flex flex-col justify-center items-center w-full lg:w-1/2 px-6 sm:px-10 py-8 lg:py-20 lg:rounded-none rounded-t-[40px]">
                    <div className="w-full max-w-md">
                        ...
                        <div className="flex flex-col items-center pt-4 lg:pt-0">
                            <Image
                                ...
                                className="mb-4"
                            />
                            <h2 className="text-center text-lg text-primary font-semibold uppercase">
                        ...
                        {(showVerifyFlag || guestUser) &&
                            <div>
                                <button type={"button"} className={"flex items-center mt-6 gap-2"} onClick={() => {
                        ...
                        {(!showVerifyFlag) ?
                            <div className="mt-6 space-y-4">
                                ...
                                <OTPVerify handleResend={handleRequestCode} verifyOtpApi={handleVerifyCode}/>
