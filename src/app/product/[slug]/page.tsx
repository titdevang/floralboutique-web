...
export default function ProductDetail({params}: ProductProps) {
    ...
    const [selectCityModal, setSelectCityModal] = useState<boolean>(false);
    ...
    const handleAddToCart = async (product: Product) => {
        ...
        if (!deliveryTimeSlot && deliveryType?.custom_shipping == 0) {
        ...
        const productPayload = {
            ...
            deliveryTimeSlot: deliveryTimeSlot as DeliveryTimeSlot,
        };
    ...
    return (
        <div>
            ...
            <Modal isOpen={selectCityModal} onClose={() => setSelectCityModal(false)} className={"max-w-lg"}
                   title={"Select City"} titleClassName={"text-center w-full"}>
                <div>
                    <CitiesDropdown
                        options={cities}
                ...
                <div className={"text-end mt-4"}>
                    <button onClick={() => setSelectCityModal(false)}
                            className={"text-white px-5 py-2 rounded-full bg-primary"}>Close
                    </button>
                </div>
            </Modal>
                  ...
                  ({product.totalReviews} reviews)
                    ...
                    <div className="space-y-8">
                        ...
                        <div className={`text-center`}>
                            <button onClick={() => setSelectCityModal(true)}
                                    className={`${!selectCities ? " animate-shadow-blink" : ""} text-white px-5 py-2 !rounded-full bg-primary`}>
                                {selectCitieName ? selectCitieName : "Select City"}
                            </button>
                            {/*<button onClick={() => setSelectCityModal(true)}*/}
                            {/*        className={`${!selectCities ? " animate-shadow-blink" : ""} text-white px-5 py-2 !rounded-full bg-primary`}>*/}
                            {/*    {selectCitieName}*/}
