...
const ProductDetailMultiCarousel: React.FC<{ categoryMenu: categoryMenu[] }> = ({ categoryMenu }) => {
        ...
        <div className="space-y-6">
            {categoryMenu.map((category) => (
                <div
                    ...
                    className="min-h-[300px] border-t border-gray-light pt-6"
                >
                    <h2 className="heading-2  !text-2xl mb-2 text-center">
                        <span className={""}>
                        {category.name}
                        </span>
                    </h2>
...
export default ProductDetailMultiCarousel;
