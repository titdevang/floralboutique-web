    ...
    const handleSaveAddress = async () => {
        try {
            const payload = {
                ...
                receiver_email: addressData.receiverEmail,
                receiver_phone: addressData.receiverPhone,
                receiver_alt_mobile: addressData.receiverAltPhone,
                sender_name: addressData.senderName,
                sender_phone: addressData.senderPhone,
            };
    ...
    const handleUpdateAddress = async (id: number) => {
        ...
        try {
            const payload = {
                ...
                receiver_name: editAddress.receiverName,
            ...
            {(addNewAddress || !addresses.length) && (
                ...
                >
                    <UsershippingInfo
                        ...
                        handleSaveFormData={handleSaveAddress}
